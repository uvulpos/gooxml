...
import (
	...
	"github.com/uvulpos/gooxml/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/uvulpos/gooxml")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/uvulpos/gooxml
